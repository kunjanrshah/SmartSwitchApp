...
public class KdGaugeView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (TextUtils.isEmpty(unitOfMeasurement)) unitOfMeasurement = "KWatt";
        ...
        mSpeedUnitTextSize = a.getDimension(R.styleable.kdgaugeview_unitOfMeasurementTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, getDisplayMetrics()));
